...
//BUF位: bit4
#define AD7799_CONFIG_BUF_EN      0x0010    //缓冲工作模式
...
#define  ADC1_CS_PORT    GPIOB  //PE1_动静脉压测试
#define  ADC2_CS_PORT    0      //PB12_肝素针管测试
...
#define  ADC1_SCLK_PORT    GPIOB   //PB8  动静脉压_与肝素针管_共用
#define  ADC2_SCLK_PORT    0   //PB8  动静脉压_与肝素针管_共用
#define  ADC3_SCLK_PORT    0   
#define  ADC4_SCLK_PORT    0   
#define  ADC1_SCLK_PIN     GPIO_Pin_12
#define  ADC2_SCLK_PIN     0
#define  ADC3_SCLK_PIN     0
#define  ADC4_SCLK_PIN     0
/**************** ADC数据输入引脚DIN 输出GPIO  --可修改 --必须为4个 **********/
#define  ADC1_DIN_PORT    GPIOB   //PB9  动静脉压_与肝素针管_共用
#define  ADC2_DIN_PORT    0   //PB9  动静脉压_与肝素针管_共用
#define  ADC3_DIN_PORT    0   
#define  ADC4_DIN_PORT    0   
#define  ADC1_DIN_PIN     GPIO_Pin_15
#define  ADC2_DIN_PIN     0
#define  ADC3_DIN_PIN     0
#define  ADC4_DIN_PIN     0
/**************** ADC数据输出引脚DOUT 输入GPIO  --可修改 --必须为4个 **********/
#define  ADC1_DOUT_PORT    GPIOB  //PE0  动静脉压_与肝素针管_共用
#define  ADC2_DOUT_PORT    0   //PE0  动静脉压_与肝素针管_共用
#define  ADC3_DOUT_PORT    0  
#define  ADC4_DOUT_PORT    0  
#define  ADC1_DOUT_PIN     GPIO_Pin_14
...
*/
#define  MEDIAN_FILTERING_BUFSIZE  8     //中位值滤波的（连续）数据采集次数. 推荐值：3,4,5,6,7,8,9,10
#define  MOVING_AVERAGE_BUFSIZE    4     //递推平均滤波的队列长度. 推荐，流量：N=12；压力：N=4；液面，N=4~12；温度，N=1~4

#define AD7799_RATE               AD7799_MODE_470HZ     //AD7799_MODE_4_17HZ        //设定ADC的转换速率
#define AD7799_GAIN               AD7799_CONFIG_GAIN_1  //设定ADC的增益
#define ADC7799_RD_CYCLE          10 //ADC读取周期时间,要求为AD7799转换周期(1/AD7799_RATE)的(1/10~1/3)
